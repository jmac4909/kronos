...
14. Use **Rename display label** on a registered Project. Confirm the new label appears in Projects, Work, the Jira board, project setup, and local search while its canonical path, linked tickets/sessions, provider configuration, and Git state remain unchanged.

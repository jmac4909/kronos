...
import { evidenceAcceptanceCriteria, evidenceChecked, evidenceRecordCount, evidenceString } from './services/evidenceData';
...
import { escapeAttr, escapeHtml, kronosWebviewBaseCss } from './services/webviewHtml';

...
<p align="center">
  ...
  <img alt="265 automated local tests" src="https://img.shields.io/badge/test%20suite-265%20local-22C55E">
...
| Automated Node/DOM/board tests | 265 |
| Built-in runtime coverage | 83.07% lines / 75.54% branches / 87.88% functions |

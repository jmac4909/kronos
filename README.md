...
<p align="center">
  ...
  <img alt="256 automated local tests" src="https://img.shields.io/badge/test%20suite-256%20local-22C55E">
...
| Automated Node/DOM/board tests | 256 |
| Built-in runtime coverage | 82.80% lines / 74.92% branches / 87.84% functions |
